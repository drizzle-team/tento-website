...
<Callout title='tips'>
If you don't have a Shopify Application and developer store yet and want to create one for testing, you can use official Shopify guide (Make sure to set up [API scopes](https://shopify.dev/docs/api/usage/access-scopes) for your Shopify Application for `metaobjects`). 
After you create Shopify Application you'll need to get your secret variables, you can use official Shopify manual for it.

The official Shopify guide is available [here](https://shopify.dev/docs/apps/build/scaffold-app).  
The official Shopify manual to get secrets [here](https://help.shopify.com/en/manual/apps/app-types/custom-apps#get-the-api-credentials-for-a-custom-app).
</Callout>
...
Metaobjects [here](https://shopify.dev/docs/api/admin-graphql/2024-10/objects/Metaobject).  
Metafields [here](https://shopify.dev/docs/api/admin-graphql/2024-10/objects/Metafield).
</Callout>
